...
%   or
%    [yi,dyi] = hermiteinterp(xi,x,y,dy,a1,a2,a3);
% INPUTS
%  xi       : an m-vector of interpolation points
%  v        : an 6-element cell array containing p-vectors x, y, dy, a1, a2, a3
%  x        : values of input variable (sorted and unique values)
%  y        : values of output variable
%  dy       : values of derivative
%  a1 a2 a3 : coefficients of the interpolating functions
% OUTPUTS
